// Vendored third-party code (public domain) - see README.md in this folder.
// CS0649: the port keeps a few struct fields that the push path never assigns.
#pragma warning disable 0649

using System;
using System.Runtime.InteropServices;
using InternetRadio.OggVorbis.Vendored.Hebron;

namespace InternetRadio.OggVorbis.Vendored
{
